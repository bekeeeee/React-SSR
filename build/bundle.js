...
var FETCH_USERS = exports.FETCH_USERS = "fetch_user";
var FETCH_CUURENT_USER = exports.FETCH_CUURENT_USER = "fetch_current_user";
...
exports.default = function (req) {
  ...
  var store = (0, _redux.createStore)(_reducers2.default, {}, (0, _redux.applyMiddleware)(_reduxThunk2.default.withExtraArgument(axiosInstance))); // add axiosInstance in thunk function
  return store;
};
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actions.FETCH_CUURENT_USER:
    ...
    _createClass(RequireAuth, [{
      ...
      value: function render() {
        switch (this.props.auth) {
          ...
          default:
            return _react2.default.createElement(ChildComponent, this.props); // props from connect function
        }
      }
    }]);
